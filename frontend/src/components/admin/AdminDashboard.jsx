  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        const resourcesResponse = await axios.get('http://localhost:8000/Resources');
              ...
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p className="text-3xl font-bold text-blue-600">{dashboardData.users.length}</p>
                  </div>
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    <h3 className="text-lg font-semibold mb-2">Active Events</h3>
                    <p className="text-3xl font-bold text-green-600">{dashboardData.events.length}</p>
                  </div>
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    <h3 className="text-lg font-semibold mb-2">Total Resources</h3>
                    <p className="text-3xl font-bold text-red-600">{dashboardData.resources.length}</p>
                  </div>
                  <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  {dashboardData.resources.length > 0 ? (
                    <div className="overflow-x-auto">
                      <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                          {dashboardData.resources.slice(0, 5).map((resource) => (
                            <tr key={resource._id}>
                              <td className="px-6 py-4 whitespace-nowrap">
