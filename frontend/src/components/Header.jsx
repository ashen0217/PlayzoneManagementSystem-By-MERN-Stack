...
const Header = () => {
  return (
    <div className='filter brightness-75 h-screen min-h-screen mb-4 bg-cover bg-center flex items-center w-full overflow-hidden' style={{backgroundImage: "url('/bg3.png')"}} id='Header'>
      <Navbar/>
      <div className='container text-center mx-auto py-4 px-6 md:px-20 lg:px-32 text-black bg-blue-400 bg-auto'>
        ...
        <div className='space-x-6 mt-16'>
          <a className='bg-white px-8 py-3 rounded' href="#Contact">Contact-us</a> 
